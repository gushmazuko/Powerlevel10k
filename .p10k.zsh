# Generated by Powerlevel10k configuration wizard on 2019-09-14 at 21:58 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 26734.
# Wizard options: nerdfont-complete + powerline, small icons, classic, darkest,
# angled separators, sharp heads, blurred tails, 2 lines, dotted, full frame, sparse,
# many icons, concise.
